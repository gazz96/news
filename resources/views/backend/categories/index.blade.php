...
<div class="container-fluid p-0">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            ...
            <a href="#offcanvasForm" data-bs-toggle="offcanvas" class="btn btn-primary" hx-trigger="click" hx-target="#formWrapper" hx-get="{{route('categories.form')}}">
    ...
    <div class="offcanvas-body">
        <form action="">
            ...
            <div class="mb-3">
                ...
                hx-get="{{route('categories.table')}}" hx-trigger="keyup changed delay:1s"
                hx-target="#table">
            </div>

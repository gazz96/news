...
<head>
    ...
    <link href="{{ url('appstack/dist/css/app.css') }}" rel="stylesheet">
...
<body>
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('categories.index')}}">
                            <i class="align-middle" data-lucide="list"></i> <span class="align-middle">Categories</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('users.index')}}">
                            <i class="align-middle" data-lucide="list"></i> <span class="align-middle">Users</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{route('posts.index')}}">
                            <i class="align-middle" data-lucide="list"></i> <span class="align-middle">Posts</span>
                        </a>
                    </li>
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        ...
                        <div class="col-6 text-end">
                            <p class="mb-0">
                                &copy; 2024 - <a href="https://instagram.com/bagas.topati" target="_blank" class="text-muted">AppStack</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ url('appstack/dist/js/app.js') }}"></script>
    <script src="{{ url('plugins/htmx/htmx.min.js') }}"></script>
